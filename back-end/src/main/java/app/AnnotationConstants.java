...
public final class AnnotationConstants {
    ...
    public static final int MIN_PAYLOAD_CAPACITY = 500;
    public static final int MAX_PAYLOAD_CAPACITY = 50000;
    public static final int MIN_NUMBER_OF_AXEL = 1;
    public static final int MAX_NUMBER_OF_AXEL = 10;
    public static final int MIN_TOP_SPEED = 30;
    public static final int MAX_TOP_SPEED = 500;
    public static final int MIN_ACCELERATION = 1;
